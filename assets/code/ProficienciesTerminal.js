...
import './ProficienciesTerminal.css';

const ProficienciesTerminal = () => {
  ...
  const renderProficiencyLevel = (level) => {
    ...
    return (
      <div className="proficiency-level-bar">
  ...
  return (
    <section className="proficiencies-terminal-section">
      <ScrollStack
        className="proficiencies-terminal-stack"
        itemDistance={80}
        itemScale={0.015}
      ...
      >
        ...
        <ScrollStackItem itemClassName="terminal-card terminal-boot-card">
        ...
        {proficiencyData.map((prof, index) => (
          <ScrollStackItem key={index} itemClassName="terminal-card">
            <div className="terminal-header">
              <span className="terminal-dots">
                <span className="dot dot-red">●</span>
                <span className="dot dot-yellow">●</span>
            ...
            <div className="terminal-body">
              ...
              <div className="terminal-output-block">
                <p className="category-label"># {prof.title}</p>
                ...
                <p className="skill-description">
                  <span className="comment-marker">//</span> {prof.description}
                </p>
              </div>
            </div>
          </ScrollStackItem>
...
export default ProficienciesTerminal;
